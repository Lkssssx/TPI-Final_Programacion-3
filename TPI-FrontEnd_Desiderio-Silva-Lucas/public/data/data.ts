...
export const PRODUCTS: Product[] = [
  {
    ...
    stock: 20,
    imagen: "/src/assets/productos/pizza_muzarella.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 15,
    imagen: "/src/assets/productos/pizza_napolitana.jpg",
    disponible: true,
    categorias: [CATEGORIAS[0]],
  },
  {
    ...
    stock: 10,
    imagen: "/src/assets/productos/pizza_4_quesos.jpg",
    disponible: true,
    categorias: [CATEGORIAS[0]],
  },
  {
    ...
    stock: 30,
    imagen: "/src/assets/productos/hamburguesa_clasica.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 25,
    imagen: "/src/assets/productos/hamburguesa_bbq_bacon.jpg",
    disponible: true,
    categorias: [CATEGORIAS[1]],
  },
  {
    ...
    stock: 0,
    imagen: "/src/assets/productos/hamburguesa_veggie.jpg",
    disponible: false,
    categorias: [CATEGORIAS[1]],
  },
  {
    ...
    stock: 100,
    imagen: "/src/assets/productos/coca_500ml.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 40,
    imagen: "/src/assets/productos/jugo_naranja.jpg",
    disponible: true,
    categorias: [CATEGORIAS[2]],
  },
  {
    ...
    stock: 150,
    imagen: "/src/assets/productos/agua_mineral.jpg",
    disponible: true,
    categorias: [CATEGORIAS[2]],
  },
  {
    ...
    stock: 12,
    imagen: "/src/assets/productos/torta_rogel.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 30,
    imagen: "/src/assets/productos/helado_artesanal.jpg",
    disponible: true,
    categorias: [CATEGORIAS[3]],
  },
  {
    ...
    stock: 0,
    imagen: "/src/assets/productos/brownie_helado.jpg",
    disponible: false,
    categorias: [CATEGORIAS[3]],
  },
  {
    ...
    stock: 50,
    imagen: "/src/assets/productos/empanadas_carne.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 45,
    imagen: "/src/assets/productos/empanadas_pollo.jpg",
    disponible: true,
    categorias: [CATEGORIAS[4]],
  },
  {
    ...
    stock: 60,
    imagen: "/src/assets/productos/empanadas_jamon_queso.jpg",
    disponible: true,
    categorias: [CATEGORIAS[4]],
  },
  {
    ...
    stock: 20,
    imagen: "/src/assets/productos/ensalada_cesar.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 18,
    imagen: "/src/assets/productos/ensalada_capresse.jpg",
    disponible: true,
    categorias: [CATEGORIAS[5]],
  },
  {
    ...
    stock: 10,
    imagen: "/src/assets/productos/pizza_fugazzeta.jpg",
    disponible: true,
    categorias: [CATEGORIAS[0]],
  },
  {
    ...
    stock: 0,
    imagen: "/src/assets/productos/hamburguesa_crispy_chicken.jpg",
    disponible: false,
    categorias: [CATEGORIAS[1]],
  },
  {
    ...
    stock: 25,
    imagen: "/src/assets/productos/ensalada_mixta.jpg",
    disponible: true,
    categorias: [CATEGORIAS[5]],
  },
]
...
export function getCategoriesFromData(): ICategory[] {
  return CATEGORIAS.filter((c) => !c.eliminado);
}

export function getProductsFromData(): Product[] {
